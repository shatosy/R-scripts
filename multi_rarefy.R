...
# Arguments: "data" is a data matrix with samples as rows and OTU, genes, or species as columns, "perms" is the number of permutations you want to run (Defaults to 999)
